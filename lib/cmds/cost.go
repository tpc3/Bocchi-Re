...
func calcTokens(msgInfo *embed.MsgInfo) (float64, error) {
	...
	tokensGPT3Dot5Turbo := (0.0015/1000)*float64(data.Tokens.GPT3Dot5Turbo.Prompt) + (0.0020/1000)*float64(data.Tokens.GPT3Dot5Turbo.Completion)
	...
	cost := rate * (tokensGPT432K0613 + tokensGPT432K0314 + tokensGPT432K + tokensGPT40613 + tokensGPT40314 + tokensGPT4TurboPreview + tokensGPT4VisionPreview + tokensGPT4 + tokensGPT3Dot5Turbo1106 + tokensGPT3Dot5Turbo0613 + tokensGPT3Dot5Turbo0301 + tokensGPT3Dot5Turbo16K + tokensGPT3Dot5Turbo16K0613 + tokensGPT3Dot5Turbo + tokensDALLE2 + tokensDALLE3)
	return cost, nil
}
